...
import { IArticle, ITag, ITopic } from "../../../models/article";
...
const WritingPage: NextPage = () => {
  ...
  const getArticleId = () => {
    ...
    const articleId = arr.length > 0 ? arr[arr.length - 1] : "";
    return articleId || "";
  }
  ...
  const getArticle = async () => {
    ...
    const article = await ArticleService.getArticleDetailById(id);
      ...
      <div className={styles.wrapper}>
        <div className={styles.editor}>
          <Editor
            ...
            initialValue={article?.content[0]}
            init={{
              height: 500,
              menubar: false,
